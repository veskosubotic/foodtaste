<?php
if (!defined('recipe-type-results')) {
  exit();
}
?>
...
if (round($article->rating) == 0) {
  ...
  <div class="col-xs-12 col-sm-3 col-md-4 col-lg-3 snip1190" id="remove-padding"">
  <img src="../wp-content/uploads/2018/04/'.$image_upload.'" style="width: 100%; height: 100%;" alt=""></a>
  <a href="recipe-details?p_id='.$p_id.'"><figcaption>
  <h2>See Recipe</h2>
  </figcaption></a>
  </div>
  <div class="col-xs-12 col-sm-9 col-md-8 col-lg-9" id="remove-padding">
  ...
  <p style="padding-right: 1px;">'.$p_short.'</p>
  <div class="row center-xs around-sm start-md start-lg">
  <div class="col-xs-12 col-sm-3 col-md-3 col-lg-2" id="remove-padding">
  <p id="user-p-recent-recipes" style="font-size: 12px;"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;'.$p_author.'</p>
  </div>
  <div class="col-xs-12 col-sm-4 col-md-4 col-lg-6" id="remove-padding">
