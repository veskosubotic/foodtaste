...
/*
Template Name: Edit Comment Template
*/
  ...
  if ($getname2 = mysqli_fetch_assoc($result2)) {
    if (isset($_SESSION['u_id'])) {
      if ($_SESSION['u_id'] == $getname2['u_id']) {
        ...
        if ($number == $number2) {
          $query2 = "SELECT comment FROM tbl_comment WHERE parent_comment_id = '0' AND comment_sender_u_id='$u_id' AND comment_id='$number'";
